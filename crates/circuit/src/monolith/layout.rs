...
// Offsets porteuses (colonnes constantes).
pub(crate) const OWNER_C: usize = CARRIER_OFF;
pub(crate) const NK_C: usize = OWNER_C + 4;
pub(crate) const RHO_C_0: usize = NK_C + 4;
pub(crate) const RHO_C_1: usize = RHO_C_0 + 4;
pub(crate) const CM_C_0: usize = RHO_C_1 + 4;
pub(crate) const CM_C_1: usize = CM_C_0 + 4;
pub(crate) const LEAF_C_0: usize = CM_C_1 + 4;
pub(crate) const LEAF_C_1: usize = LEAF_C_0 + 4;
pub(crate) const VIN_C_0: usize = LEAF_C_1 + 4;
pub(crate) const VIN_C_1: usize = VIN_C_0 + 1;
pub(crate) const VOUT_C_0: usize = VIN_C_1 + 1;
pub(crate) const VOUT_C_1: usize = VOUT_C_0 + 1;

// Segments de lignes dans une éponge de dépense U_i.
...
///
/// Retourne `max(256, 16*depth)`, où 256 est le minimum absolu et 16*depth
/// est le minimum basé sur la taille du chemin Merkle.
